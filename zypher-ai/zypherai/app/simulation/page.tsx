  ...
  return (
    <div className="space-y-8 animate-fade-in-up pb-20">
      ...
      <div className="bg-[#0f1423] p-6 lg:p-10 rounded-[2.5rem] border border-cyan-500/10 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            <div>
                ...
                <h1 className="text-3xl md:text-4xl font-light text-white tracking-tight">War Room Simulation</h1>
                <p className="text-slate-400 font-medium mt-2 tracking-wide text-xs md:text-sm max-w-2xl">Stress-test network resilience against demand spikes and geopolitical delays.</p>
            </div>
            
            <div className="bg-[#161b2a] border border-rose-500/20 px-6 py-4 rounded-xl shadow-inner text-left md:text-right w-full md:w-auto">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 lg:h-[550px]">
        ...
        {/* CONTROL PANEL */}
        <div className="xl:col-span-4 bg-[#0f1423] p-6 lg:p-8 rounded-[2.5rem] border border-cyan-500/10 shadow-2xl flex flex-col min-h-[400px] lg:h-full">
            ...
            <div className="space-y-10 flex-1">
                ...
                <div className="space-y-4">
                    ...
                    />
                    <p className="text-[10px] md:text-xs text-slate-500 font-medium leading-relaxed">Simulates unexpected market spikes or viral marketing campaigns.</p>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    />
                    <p className="text-[10px] md:text-xs text-slate-500 font-medium leading-relaxed">Simulates geopolitical port closures, weather events, or vendor failure.</p>
                </div>
            </div>

            <button onClick={() => {setDemandSpike(0); setDelayDays(0);}} className="w-full py-4 border border-white/10 rounded-xl text-[10px] font-bold text-slate-400 uppercase tracking-widest hover:bg-white/5 transition-all mt-8 active:scale-95">
                Reset Parameters
            </button>
        </div>

        {/* VISUALIZATION CHART */}
        <div className="xl:col-span-8 bg-[#0f1423] p-4 sm:p-6 lg:p-8 rounded-[2.5rem] border border-cyan-500/10 shadow-2xl flex flex-col relative overflow-hidden min-h-[400px] lg:h-full">
            <h3 className="text-xs md:text-sm font-bold text-slate-300 uppercase tracking-widest mb-6 relative z-10 px-2">Projected Inventory Impact</h3>
            
            {/* Absolute wrapper to prevent Recharts collapse */}
                ...
                <div className="absolute inset-0">
                    <ResponsiveContainer width="100%" height="100%">
                        <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                            ...
                            <Legend verticalAlign="top" height={36} iconType="circle" wrapperStyle={{ fontSize: '10px', color: '#94a3b8', fontWeight: 'bold' }} />

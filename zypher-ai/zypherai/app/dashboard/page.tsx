...
export default function DashboardPage() {
  return (
    <div className="space-y-8 animate-fade-in-up pb-20">
      {/* HEADER SECTION */}
      <div className="bg-[#0f1423] p-6 lg:p-10 rounded-[2rem] border border-white/5 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-3xl md:text-4xl font-light text-white tracking-tight">Global Command Center</h1>
          <p className="text-slate-400 font-medium mt-2 tracking-wide text-xs md:text-sm">Autonomous tracking & supply chain intelligence.</p>
        </div>
